...
# ============================================================
# ===== EXISTING COMMANDS (All previous functions – same as before) =====
# ============================================================
# I will not repeat all the code here for brevity, but in the final answer I will include the complete code.
# The user can refer to the previous working code for these functions.
# I will provide a complete code block in the answer.
