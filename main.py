...
async def attack_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        # POWER CONFIG: 5 runners × 100 threads
...
async def about_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "⚡ <b>Version:</b> 2.0 (GENZ EDITION)\n"
        "👨‍💻 <b>Built with:</b> Python, Pyrogram, GitHub Actions\n"
        "🔥 <b>Architecture:</b> 5 Parallel Runners × 100 Threads\n"
...
# ============================================================
# ===== ADMIN USER COMMANDS (keep functional, style tweaked) =====
# ============================================================
