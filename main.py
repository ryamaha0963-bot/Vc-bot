...
def start_attack(attack_id, ip, port, time_val, user_id):
    ...
    active_attacks[attack_id] = {
        ...
        "timer_task": None   # will be set after creation
    }
    save_json('attack_state.json', active_attacks)   # optional, can keep

def finish_attack(attack_id):
    """Remove an attack from active_attacks."""
    if attack_id in active_attacks:
        # Cancel the timer task if any
...
def is_attack_running():
    """Check if any attack is active (based on timers)."""
...
# ============================================================
# ===== ATTACK COMMAND (FAST + CONCURRENT) =====
# ============================================================
...
# ============================================================
# ===== OTHER COMMANDS (modified /status, /stop) =====
# ============================================================
...
def main():
    try:
        ...
        logger.info("🚀 Bot is running! (concurrent attacks enabled)")
