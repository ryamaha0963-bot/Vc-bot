...
# 🔒 LOCK to prevent double attack race condition
...
# ============================================================
# ===== TOKEN COMMANDS (FIXED - NO DUPLICATES) =====
# ============================================================
...
async def attack_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    # 🔒 YAHAN LOCK LAGAYA - Ek baar mein sirf ek attack command process hogi
    async with attack_lock:
        try:
            ...
            # Abhi se attack state set kar rahe hain taaki koi aur command na aa sake
            # Pehle arguments parse karte hain
